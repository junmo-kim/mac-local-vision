...
public enum CLIHelp {
    ...
    private static let usages: [String: String] = [
        ...
        "ask": "usage: macvis ask <image|pdf> --prompt <text> [--stream] [--schema <path|json>] [--page N] [--scale S] [--format yaml|json]   (needs macOS 27)",
        ...
        "serve": "usage: macvis serve [--host H] [--port N] [--max-body MIB]   (HTTP MCP server for remote nodes; default 0.0.0.0:9090, body cap 20 MiB)",
    ]
